...
const navItems = [
  ...
  { label: "Devocionales", href: "/admin/devocionales", icon: BookOpen },
  ...
  return (
    <html lang="es" className={`${inter.variable} ${playfair.variable}`}>
      <body className="font-sans bg-slate-50 min-h-screen flex">
        {/* Sidebar */}
        <aside className="w-64 shrink-0 bg-navy-950 text-white min-h-screen flex flex-col hidden lg:flex">
          {/* Brand */}
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="lg:hidden bg-navy-950 text-white px-4 py-3 flex items-center justify-between border-b border-white/10">
            ...
            <Link href="/" className="text-navy-300 hover:text-white text-sm">
              ← Sitio
            </Link>
          </header>
