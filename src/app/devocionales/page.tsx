...
export const metadata: Metadata = {
  title: "Devocionales",
  description:
    "Reflexiones bíblicas para alimentar tu fe cada día. Explora nuestra colección de devocionales escritos por miembros de Centro Cristiano Adoram.",
};
  ...
  return (
    <div className="min-h-screen bg-warm-50">
      ...
      <div className="bg-navy-gradient py-24 pt-32 text-white text-center">
        ...
        <p className="text-navy-200 text-lg max-w-xl mx-auto leading-relaxed px-4">
          Reflexiones bíblicas para alimentar tu alma cada día. Escritas por
          miembros de nuestra comunidad de fe.
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-warm-200 shadow-card p-5">
                <h2 className="font-bold text-navy-800 text-sm mb-3">Buscar</h2>
              ...
              {/* Categories */}
              <div className="bg-white rounded-2xl border border-warm-200 shadow-card p-5">
                <h2 className="font-bold text-navy-800 text-sm mb-3">
                  Categorías
                </h2>
          ...
          <main className="lg:col-span-3">
            <p className="text-slate-500 text-sm mb-6">
              {devotionals.length} devocional{devotionals.length !== 1 ? "es" : ""} publicado{devotionals.length !== 1 ? "s" : ""}
            </p>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-1.5 mb-3">
                        ...
                        {devotional.isFeatured && (
                          <Badge variant="navy">Destacado</Badge>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-warm-100">
                        ...
                        {devotional.readingTimeMinutes && (
                          <span className="flex items-center gap-1 text-xs text-warm-500">
                            <Clock size={11} />
                            {devotional.readingTimeMinutes} min
                          </span>
                        )}
                      </div>
                    </div>
            ...
            {devotionals.length === 0 && (
              <div className="text-center py-20 text-slate-400">
                ...
                <p className="text-lg font-semibold">Pronto habrá nuevos devocionales</p>
                <p className="text-sm mt-1">Vuelve pronto — hay reflexiones en camino.</p>
              </div>
            )}
          </main>
        </div>
